...
const sendSong = (sock, msg, query, extra = {}) => downloadQueue.run(() => sendSongLocal(sock, msg, query, extra));

// Local download (primary flow — no orchestrator, no quota)
...
// Audio download resolver (local only)
